...
async function pe(e, t, n, o, r, i, u, a, l) {
  ...
  return (
    document.dispatchEvent(f) &&
      (await f.loader(),
      f.defaultPrevented || (de(le), f.navigationType !== 'traverse' && x({ scrollX, scrollY }))),
    f
  )
}
function ge(e, t) {
...
history.state
  ...
  : I() && (T({ index: b, scrollX, scrollY }, ''), (history.scrollRestoration = 'manual'))
  ...
  if (
    ...
    if (e.hash) {
      ...
      ;(location.href = e.href),
        history.state || (T(l, ''), i && window.dispatchEvent(new PopStateEvent('popstate')))
...
async function G(e, t, n, o, r) {
  ...
  const a = await pe(t, n, e, u, o.sourceElement, o.info, i.controller.signal, o.formData, l)
...
}
{
  ...
  for (const e of document.getElementsByTagName('script')) B(e), (e.dataset.astroExec = '')
}
const z = new Set(),
  E = new WeakSet()
let k,
